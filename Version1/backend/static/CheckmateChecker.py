    ...
    while i < len(piecesArray):
        ...
        if not isinstance(pieceName, King):
            if pieceName.is_black and isBlack == 1:
                if move_checker(currentBoard, pieceNotation, checkPieceNotation, 0):
                    return False
        ...
        if coordsCheckPiece[1] < kingCol:
            while checkCol < kingCol:
                ...
                while j < len(piecesArray):
                    ...
                    if not isinstance(pieceName, King):
                        if pieceName.is_black and isBlack == 1:
                            if move_checker(currentBoard, pieceNotation, blockNotation, 0):
                                return False
                            elif not pieceName.is_black and isBlack == 0:
                                if move_checker(currentBoard, pieceNotation, blockNotation, 0):
                                    return False
        ...
        # Horizontal Right Check -
            ...
            while checkCol > kingCol:
                ...
                while j < len(piecesArray):
                    ...
                    if not isinstance(pieceName, King):
                        if pieceName.is_black and isBlack == 1:
                            if move_checker(currentBoard, pieceNotation, blockNotation, 0) == True:
                                return False
                        elif not pieceName.is_black and isBlack == 0:
                            if move_checker(currentBoard, pieceNotation, blockNotation, 0) == True:
                                return False
